...
print(f"Aggregating Nematic KDE data across environments for A0={A0_target}...")
...
for idx, ((C, D), delta) in enumerate(sorted_envs):
    ...
    for seed in range(1, num_seeds + 1):
        ...
        filename_template = f"Nematic_KDE_{seed}.txt" 
        kde_file = base_path / filename_template
...
# 3. STYLING & SAVING
# ============================================================
plt.title(fr"Average Nematic Order Distribution under Antibiotic Stress ($A_0$={A0_target})", fontweight='bold')
plt.xlabel(r"Local Nematic Order Parameter ($S$)", fontweight='bold')
plt.ylabel("Probability Density", fontweight='bold')

# Move the legend outside to keep the plot area clean
...
# Save the plot
plot_filename = RESULTS_DIR / f"Combined_Nematic_Distribution_A0-{A0_target}.png"
